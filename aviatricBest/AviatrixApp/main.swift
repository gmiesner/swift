...
func fly(myPlane : Aviatrix) {
    ...
    for (index, city) in destinations.enumerated() {
        let distance = myPlane.distanceTo(target: city, location: myPlane.currentLocation)
...
var plane = Aviatrix(userAuthor: "Gabriella", userAirline: "Klossy Air")
...
print(" ")
print("Thanks for flying with \(plane.airline)! Enjoy your flight! :) ")
